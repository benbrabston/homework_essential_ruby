...
loan_quotes.each do |bank_num|
  monthly_pmt = pmt(bank_num["annual_rate"]/12,number_of_monthly_payments,principal_amount)
  puts "The monthly payment from #{bank_num["bank"]} will be $#{monthly_pmt.round(2)}"
end
